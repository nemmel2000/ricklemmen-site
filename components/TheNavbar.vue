<template>
  <nav class="fixed top-0 left-0 z-50 w-full bg-transparent nav" id="TheNavbar">
    <div
      class="container-custom flex items-center justify-between py-3 mx-auto"
    >
      ...
      <div class="flex items-center justify-end gap-x-10 w-full">
        <div class="bg-tertiary rounded-extra px-8 py-4 block">
          <div
            class="inline-flex items-center justify-center gap-x-10 h-min translate-y-0.5"
          >
            <button
            ...
            <div class="inline-flex items-center gap-x-6 nav-items pr-4">
              <RouterLink
                to="/"
                class="nav-item after:animate pointer-cursor scroll-to-top"
                >Home</RouterLink
              >
              <span class="nav-item after:animate scroll-to-more"
                >About me</span
              >
              <span class="nav-item after:animate scroll-to-projects"
                >Projects</span
              >
...
.nav-item {
  @apply block text-white relative before:bg-white before:absolute before:-bottom-1 before:block before:h-0.5 before:w-full before:origin-bottom-right before:scale-x-0 before:transition before:duration-300 before:ease-in-out hover:before:origin-bottom-left hover:before:scale-x-100 before:z-10;
}
