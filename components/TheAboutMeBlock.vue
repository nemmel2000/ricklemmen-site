<template>
  <section id="about-me" class="mt-20">
    <div class="container grid grid-cols-12">
      <div class="col-span-full lg:col-span-5 relative ani-exit">
        <div class="flex flex-col gap-y-6 pl-10 pt-10 relative z-10">
          <div class="flex flex-col justify-between">
            ...
            <h2 class="text-3xl lg:text-5xl xl:text-7xl 2xl:text-8xl text-white">Creative Front-End Ontwikkelaar</h2>
          </div>
<!--          <NuxtPicture-->
...
<!--          />-->
      ...
      <div class="col-span-full lg:col-span-6 lg:col-start-7">
        <div class="flex flex-col gap-y-3 text-white pt-20 ani-enter">
          <p>
