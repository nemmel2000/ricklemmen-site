  ...
  <nav class="fixed top-8 left-0 w-full z-100 px-4">
    <div class="container-xl">
      <div class="flex justify-between items-end">
        ...
        <div
          class="gap-x-4 animate pb-3 border-b h-max nav-items hidden md:flex"
          :class="positionY > 80 ? 'border-b-transparent' : 'border-b-white/80'"
        >
          <div class="nav-item" data-scroll-to="about">Over mij</div>
          <div class="nav-item" data-scroll-to="projects">Cases</div>
          <div class="nav-item" data-scroll-to="contact">Contact</div>
        </div>
      </div>
    </div>
  </nav>
